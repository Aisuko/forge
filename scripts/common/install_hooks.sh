...
echo "  pre-commit   ./scripts/local/ci_local.sh fast   fmt, clippy, wasm + forge-top builds"
echo "  pre-push     ./scripts/local/ci_local.sh full   the above + cargo test --release"
echo
